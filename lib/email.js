    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api FahrozaBot - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6285971801289">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>FahrozaBot</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"FahrozaBot" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api FahrozaBot`,
        html: inboxGmail,
      };
